...
if st.button("📊 점검 결과 저장 및 구글 시트 전송", use_container_width=True):
    ...
    if sheet:
        try:
            sheet.append_row(list(new_data.values()), value_input_option='USER_ENTERED')
